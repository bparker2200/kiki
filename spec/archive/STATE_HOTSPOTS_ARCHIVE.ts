 ...
 * Archived: 2025-12-31
 * 
 * Purpose: Preserve hotspots + risks for future clickable map work.
 * This file is not imported by the app and exists only as an archive.
 * 
 * Original source: src/data/states.ts
 */
